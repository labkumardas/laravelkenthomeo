        ...
        <div class="col-lg-4">
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card overflow-hidden">
                <div class="card-body p-4">
                  <h5 class="card-title mb-9 fw-semibold">Total Category</h5>
                  <div class="row align-items-center">
                    <div class="col-8">
        ...
        <div class="col-lg-4">
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card overflow-hidden">
                <div class="card-body p-4">
                  <h5 class="card-title mb-9 fw-semibold">Total Blog</h5>
                  <div class="row align-items-center">
                    <div class="col-8">
                      <h4 class="fw-semibold mb-3">10</h4>
                      <div class="d-flex align-items-center mb-3">
        ...
        <div class="col-lg-4">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card overflow-hidden">
                <div class="card-body p-4">
                  <h5 class="card-title mb-9 fw-semibold">Total Transactions</h5>
                  <div class="row align-items-center">
                    <div class="col-8">
                      <h4 class="fw-semibold mb-3">200</h4>
                      <div class="d-flex align-items-center mb-3">
